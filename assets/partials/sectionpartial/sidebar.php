    ...
    <div class="d-flex flex-column h-100">
        ...
        <nav class="sidebar-nav flex-grow-1 px-3 py-2">
            <ul id="sidebarnav" class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="../section_head/dashboard.php">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="researchCollapse">
                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            <li><a href="../section_head/researchPending.php" class="nav-link ps-4"><i
                                        class="fa fa-hourglass-start me-2"></i> Research Pending</a></li>
                            <li><a href="../section_head/researchApproved.php" class="nav-link ps-4"><i
                                        class="fa fa-check-circle me-2"></i> Research Approved</a></li>
                            <li><a href="../section_head/researchCancelled.php" class="nav-link ps-4"><i
                                        class="fa fa-upload me-2"></i>
                                    Research Cancelled</a></li>
                            <li><a href="../section_head/researchRejected.php" class="nav-link ps-4"><i
                                        class="fa fa-times-circle me-2"></i> Research Rejected</a></li>
                            <li><a href="../section_head/researchRevised.php" class="nav-link ps-4"><i
                ...
                <!-- Section: section_head Settings -->
                <li class="nav-small-cap text-uppercase text-muted mt-4 mb-2">section head Settings</li>
                <li class="nav-item">
                    <a class="nav-link d-flex align-items-center" href="../section_head/profile.php">

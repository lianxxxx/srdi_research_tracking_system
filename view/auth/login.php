...
// Initialize flash error message
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    if (is_array($user)) {
        ...
        // Failed login, set flash message
        $_SESSION['login_error'] = "Incorrect email or password";
    }
...
// Get and clear flash error message
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5 rounded-3 shadow-lg">
              ...
              <form action="" method="post" class="pt-3">
                ...
                <div class="form-group">
                  ...
                  <input type="email"  
                         name="email" 
                         class="form-control form-control-lg rounded-3 <?= $login_error ? 'is-invalid' : '' ?>"
                ...
                <div class="form-group">
                  ...
                  <?php if ($login_error): ?>
                    <small class="text-danger"><?= htmlspecialchars($login_error) ?></small>
                  <?php endif; ?>
                </div>

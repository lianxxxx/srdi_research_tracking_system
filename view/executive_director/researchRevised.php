...
if (!isset($_SESSION['user_id']) || strtolower($_SESSION['role']) !== 'executive_director') {
...
// Fetch revised research papers
$revisedPapers = $db->getRevisedResearchPapers();
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title text-center mb-4 text-info">Revised Research Papers</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="8" class="text-center text-muted">No revised research papers found.
                                            </td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>

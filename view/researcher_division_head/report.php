...
// Check if user is logged in and is Researcher Division Head
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'researcher_division_head') {
...
// Get research papers by creator (use user_id, not name)
$researchPapers = $db->getResearchPapersByCreatorId($_SESSION['user_id']);
?>
            ...
            <div class="col">
                <nav aria-label="breadcrumb" class="rounded-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="#">Researcher Division Head</a></li>
                                        ...
                                        <?php if (!empty($researchPapers)) : ?>
                                            <?php foreach ($researchPapers as $paper) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/srdi_system/assets/researchPaper/<?= urlencode($paper['pdf_filename']) ?>" target="_blank">
                                                            View Research
                                                        </a>
                                                    </td>
                                                </tr>

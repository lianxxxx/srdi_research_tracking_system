...
// ✅ Fetch only this researcher’s cancelled papers
$cancelledPapers = $db->getCancelledResearchPapersByUser($researcherName);
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title text-center mb-4">My Cancelled Research Papers</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    <?php else: ?>
                                        <tr>
                                            <td colspan="7" class="text-center text-muted">No cancelled research papers found.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
